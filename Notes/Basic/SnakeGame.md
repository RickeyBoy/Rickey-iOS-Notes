...
|                   | 总价 | 单价（按套内面积） | 套内面积        | 建筑面积 | 装修情况 |
| ----------------- | ---- | ------------------ | --------------- | -------- | -------- |
| 天府公园未来城    | 343w | 2.34w              | 146.3           | 189.45   | 清水     |
| 恒大天府半岛 7 期 | 168w | ~1.68w             | 100左右(确认中) | 122.85   | 精装     |

根据您上传的图片文件，我将整理出包含图片名和对应的颜色 Hex 值的表格。请注意，由于图片内容中的颜色值已经包含了 "#"，因此在表格中我将直接使用这些值，而不添加额外的 "#"。下面是整理好的表格内容：

| 图片名             | 颜色 Hex 值1 | 颜色 Hex 值2 | 颜色 Hex 值3 | 颜色 Hex 值4 | 颜色 Hex 值5 |
| ------------------ | ------------ | ------------ | ------------ | ------------ | ------------ |
| 1. 亡灵节.png      | #FFA9CB      | #833674      | #C94145      | #8ABCF0      | #B8B755      |
| 2. 古巴城市.png    | #09A6D9      | #95CAEC      | #9FEBD7      | #F8C065      | #FD6B76      |
| 3. 印加古迹.png    | #D4D1C6      | #818B74      | #818659      | #98B25D      | #345072      |
| 4. 纱线画.png      | #490911      | #BB3908      | #E27600      | #7356BA      | #111283      |
| 5. 彩色骷髅头.png  | #064243      | #69C745      | #CCE266      | #29B0CD      | #414DB2      |
| 6. 街头音乐家.png  | #0189C8      | #00D1F5      | #FFE9A4      | #FCB250      | #E65C02      |
| 7. 拉丁舞.png      | #070302      | #592704      | #E0011D      | #F5566F      |              |
| 8. 墨西哥小镇.png  | #DB5977      | #F3A7B2      | #FCA767      | #00AA91      | #0165B7      |
| 9. 里约的夜.png    | #766D98      | #3C5880      | #4F354B      | #FABD02      | #BCB7C7      |
| 10. 伊瓜苏瀑布.png | #253629      | #657D42      | #8EA478      | #CAD059      | #89AFE1      |
| 11. 亚马逊晨雾.png | #FBE7C5      | #E1C999      | #978458      | #445130      |              |
| 12. 狂欢节.png     | #FF733B      | #E9241D      | #A00A1C      | #B5785B      | #49747B      |

请注意，表格已经根据图片名进行了递增排序。如果某些图片中的颜色值少于五个，表格中的相应列将留空。
